...
class TestWorkflow1_GenericMedicineScanner:
    ...
    def test_workflow_success(self, client, db_session):
        ...
        with _patch_ocr(ocr_text):
            with patch.object(
                ...
                # Need to mock since GenericFinderService does real DB queries
                # This test setup creates real meds but mocking to ensure isolation
                pass
    ...
    def test_workflow_unknown_medicine(self, client):
    ...
    def test_workflow_invalid_image(self, client):
    ...
    def test_workflow_ocr_text_empty_after_cleaning(self, client):
...
class TestWorkflow2_PharmacyBillScanner:
    ...
    def test_workflow_single_medicine_with_qty(self, client):
    ...
    def test_workflow_multiple_medicines_order_preserved(self, client):
    ...
    def test_workflow_missing_quantity(self, client):
    ...
    def test_workflow_empty_bill_rejected(self, client):
    ...
    def test_workflow_no_db_writes(self, client, db_session):
    ...
    def test_workflow_blurry_image_handled(self, client):
...
class TestWorkflow3_MedicalDocumentScanner:
    ...
    def test_workflow_prescription(self, client):
    ...
    def test_workflow_lab_report(self, client):
    ...
    def test_workflow_discharge_summary(self, client):
    ...
    def test_workflow_medical_certificate(self, client):
    ...
    def test_workflow_unknown_document(self, client):
    ...
    def test_workflow_missing_fields(self, client):
    ...
    def test_workflow_ocr_failure(self, client):
        """OCR failure → 500."""
        with patch("app.api.routes.ocr._ocr_service.extract_bytes") as mock:
