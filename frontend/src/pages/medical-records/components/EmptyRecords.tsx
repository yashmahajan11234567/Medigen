...
export function EmptyRecords() {
  return (
    <div className="flex flex-col items-center justify-center rounded-3xl border-2 border-dashed border-slate-200 bg-white/50 p-12 text-center">
      ...
      <p className="mt-4 text-sm font-medium text-slate-500">No medical records available.</p>
      <p className="mt-1 text-xs text-slate-400">Records you add will appear here</p>
    </div>
  );
}