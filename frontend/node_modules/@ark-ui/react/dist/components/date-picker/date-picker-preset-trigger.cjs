...
var splitPresetTriggerProps = require_create_split_props.createSplitProps();
var DatePickerPresetTrigger = (0, react.forwardRef)((props, ref) => {
	const [presetTriggerProps, localProps] = splitPresetTriggerProps(props, ["value"]);
	const mergedProps = (0, _zag_js_react.mergeProps)(require_use_date_picker_context.useDatePickerContext().getPresetTriggerProps(presetTriggerProps), localProps);
