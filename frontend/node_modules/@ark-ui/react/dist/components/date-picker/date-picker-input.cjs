...
var DatePickerInput = (0, react.forwardRef)((props, ref) => {
	const [inputProps, localProps] = splitInputProps(props, ["index", "fixOnBlur"]);
	const mergedProps = (0, _zag_js_react.mergeProps)(require_use_date_picker_context.useDatePickerContext().getInputProps(inputProps), localProps);
