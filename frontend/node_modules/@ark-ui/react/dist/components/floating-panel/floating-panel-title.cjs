...
var FloatingPanelTitle = (0, react.forwardRef)((props, ref) => {
	const mergedProps = (0, _zag_js_react.mergeProps)(require_use_floating_panel_context.useFloatingPanelContext().getTitleProps(), props);
