...
const require_use_tour_context = require("./use-tour-context.cjs");
let react = require("react");
let _zag_js_react = require("@zag-js/react");
let react_jsx_runtime = require("react/jsx-runtime");
//#region src/components/tour/tour-spotlight.tsx
var TourSpotlight = (0, react.forwardRef)((props, ref) => {
	const tour = require_use_tour_context.useTourContext();
	const presence = require_use_presence.usePresence({
		...require_render_strategy.useRenderStrategyPropsContext(),
		present: tour.open
	});
	const mergedProps = (0, _zag_js_react.mergeProps)(tour.getSpotlightProps(), presence.getPresenceProps(), props);
