...
interface DialogSchema {
    ...
    action: "checkRenderedElements" | "setInitialFocus" | "invokeOnClose" | "invokeOnOpen" | "toggleVisibility" | "setTriggerValue";
    event: {
...
export type { DialogApi, DialogMachine, DialogProps, DialogSchema, DialogService, ElementIds, OpenChangeDetails, TriggerProps, TriggerValueChangeDetails };
