...
import { PropTypes, RequiredBy, DirectionProperty, CommonProperties, OrientationProperty } from '@zag-js/types';
...
interface ProgressApi<T extends PropTypes = PropTypes> {
    /**
...
export type { ElementIds, IntlTranslations, ProgressApi, ProgressMachine, ProgressProps, ProgressSchema, ProgressService, ProgressState, ValueChangeDetails, ValueTranslationDetails, ViewProps };
