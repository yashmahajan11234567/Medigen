...
var switch_machine_exports = {};
__export(switch_machine_exports, {
  machine: () => machine
});
module.exports = __toCommonJS(switch_machine_exports);
  ...
  implementations: {
    ...
    actions: {
      ...
      syncInputElement({ context, scope }) {
        ...
        if (!inputEl) return;
        (0, import_dom_query.setElementChecked)(inputEl, !!context.get("checked"));
      },
      ...
      dispatchChangeEvent({ context, scope }) {
        queueMicrotask(() => {
          const inputEl = dom.getHiddenInputEl(scope);
          (0, import_dom_query.dispatchInputCheckedEvent)(inputEl, { checked: context.get("checked") });
        });
      }
    }
  }
