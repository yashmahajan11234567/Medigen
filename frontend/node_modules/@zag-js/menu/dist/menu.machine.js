...
var import_menu = require("./menu.utils.js");
...
var machine = (0, import_core.createMachine)({
  ...
  computed: {
    ...
    highlightedId: ({ context, scope, refs }) => (0, import_menu.resolveItemId)(refs.get("children"), context.get("highlightedValue"), scope)
  },
  ...
  implementations: {
    ...
    effects: {
      ...
      trackInteractOutside({ refs, scope, prop, context, send }) {
        ...
        const isWithinAnyContextTrigger = (target) => {
          return dom.getContextTriggerEls(scope).some((el) => (0, import_dom_query.contains)(el, target));
        };
        return (0, import_dismissable.trackDismissableElement)(getContentEl2, {
          ...
          onEscapeKeyDown(event) {
            ...
            (0, import_menu.closeRootMenu)({ parent: refs.get("parent") });
          },
      ...
      trackPointerMove({ context, scope, send, refs }) {
        ...
        if (!parent) return;
        (0, import_menu.setParentRoutingLock)(parent, true);
        const doc = scope.getDoc();
        return (0, import_dom_query.addDomEvent)(doc, "pointermove", (e) => {
          const isMovingToSubmenu = (0, import_menu.isWithinPolygon)(context.get("intentPolygon"), {
            x: e.clientX,
            y: e.clientY
          });
          if (!isMovingToSubmenu) {
            send({ type: "POINTER_MOVED_AWAY_FROM_SUBMENU" });
            (0, import_menu.setParentRoutingLock)(parent, false);
          }
        });
      },
    ...
    actions: {
      ...
      unlockParentOnClose({ refs, context }) {
        (0, import_menu.unlockParentAfterChildClose)(refs.get("parent"), context.get("isSubmenu"));
      },
      ...
      releaseParentRoutingLock({ refs, context }) {
        if (!context.get("isSubmenu")) return;
        (0, import_menu.unlockParentOnSubmenuClose)(refs.get("parent"));
      },
