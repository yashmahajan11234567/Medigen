...
type ChildMenuService = MenuService;
type ParentMenuService = MenuService;
...
export type { Api, ChildMenuService, ElementIds, HighlightChangeDetails, ItemBaseProps, ItemGroupLabelProps, ItemGroupProps, ItemListenerProps, ItemProps, ItemState, MenuApi, MenuMachine, MenuProps, MenuSchema, MenuService, NavigateDetails, OpenChangeDetails, OptionItemProps, OptionItemState, ParentMenuService, SelectionDetails, TriggerProps, TriggerValueChangeDetails };
