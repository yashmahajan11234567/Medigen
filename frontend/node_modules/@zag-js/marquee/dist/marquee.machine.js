...
var marquee_machine_exports = {};
__export(marquee_machine_exports, {
  machine: () => machine
});
module.exports = __toCommonJS(marquee_machine_exports);
var import_core = require("@zag-js/core");
var import_marquee = require("./marquee.dom.js");
  ...
  implementations: {
    actions: {
      ...
      restartAnimation({ scope }) {
        const viewportEl = import_marquee.dom.getViewportEl(scope);
    ...
    effects: {
      trackDimensions({ scope, refs, computed, context, prop }) {
        const rootEl = import_marquee.dom.getRootEl(scope);
        const contentEl = import_marquee.dom.getContentEl(scope, 0);
