...
var checkbox_connect_exports = {};
__export(checkbox_connect_exports, {
  connect: () => connect
});
module.exports = __toCommonJS(checkbox_connect_exports);
var import_dom_query = require("@zag-js/dom-query");
var import_focus_visible = require("@zag-js/focus-visible");
var import_checkbox = require("./checkbox.anatomy.js");
...
function connect(service, normalize) {
  ...
  const dataAttrs = {
    "data-active": (0, import_dom_query.dataAttr)(context.get("active")),
  ...
  return {
    ...
    getRootProps() {
      return normalize.label({
        ...import_checkbox.parts.root.attrs,
        ...dataAttrs,
        dir: prop("dir"),
    ...
    getLabelProps() {
      return normalize.element({
        ...import_checkbox.parts.label.attrs,
        ...dataAttrs,
        dir: prop("dir"),
    ...
    getControlProps() {
      return normalize.element({
        ...import_checkbox.parts.control.attrs,
        ...dataAttrs,
        dir: prop("dir"),
    ...
    getIndicatorProps() {
      return normalize.element({
        ...import_checkbox.parts.indicator.attrs,
        ...dataAttrs,
        dir: prop("dir"),
