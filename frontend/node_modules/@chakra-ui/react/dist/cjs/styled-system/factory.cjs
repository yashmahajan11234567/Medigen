...
const createStyled = (tag, configOrCva = {}, options = {}) => {
  ...
  const Styled = react.withEmotionCache((inProps, cache2, ref$1) => {
    ...
    if (props.asChild && !forwardAsChild) {
      const child = React__namespace.isValidElement(props.children) ? React__namespace.Children.only(props.children) : React__namespace.Children.toArray(props.children).find(React__namespace.isValidElement);
      if (!child) {
