...
export declare function createOverlay<T extends Dict>(Component: React.ComponentType<T & CreateOverlayProps>, options?: OverlayOptions<T>): CreateOverlayReturn<T>;
