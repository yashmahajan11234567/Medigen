...
type RecipeDefaultVariants<T extends RecipeVariantRecord | SlotRecipeVariantRecord<string>> = keyof any extends keyof T ? Record<string, ConditionalValue<any>> : RecipeSelection<T>;
...
export interface RecipeDefinition<T extends RecipeVariantRecord = RecipeVariantRecord> {
     ...
     */
    defaultVariants?: (RecipeDefaultVariants<T> & {
